...
if (process.env.NODE_ENV === "development") {
  document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY2ODEzMDY0NDY3OSwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.1dSyAeCRbrrcuyagqmv-wNgoJlFbt--DeW9NOp7YPZ8";
  apiContextPath = "/api";
}
