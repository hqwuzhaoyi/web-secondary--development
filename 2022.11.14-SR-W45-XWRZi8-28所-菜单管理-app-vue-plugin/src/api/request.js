...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3MTI2NzIxMjQ1OCwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.ZNVOW1NDRW685K82W-oAvlUQhoWNE-rW9kc2y3MAO8A";
   apiContextPath = "/api";
}
