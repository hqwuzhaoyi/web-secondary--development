...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3MDgzMTI0OTgxNSwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.-HOBdbReUUKFI24RlepyyAqSoLa25DPFvop_LXbIEUg";
   apiContextPath = "/api";
}
