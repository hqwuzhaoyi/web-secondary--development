      ...
      <div class="alarmt_two_right">
        <div class="head_secaher">
          ...
          <div class="grid-content bg-purple">所在省份：<el-select v-model="paramsObj.province" :popper-append-to-body="true"
              :disabled="Boolean(province)" popper-class="two_options" size="small" placeholder="请选择"
          ...
          <div class="alarmt_two_main_table">
            ...
            <div class="alarmt_two_main_table_main">
              <el-table :data="tableData" style="width: 100%" stripe>
                ...
                <el-table-column prop="defensetotal" label="防御总次数" align="center">
                ...
                <el-table-column prop="lastAlarm" label="最后发生时间" min-width="124">
                </el-table-column>
              </el-table>
...
export default {
  ...
  methods: {
    ...
    initEchartFn(data) {
      ...
      let rota = this.paramsObj.period == '月' ? 60 : 0

      let option = {
        color: [' #2699FF', ' #30D994', '#FF6969'],
        tooltip: {
          trigger: 'axis',
          axisPointer: {
            lineStyle: {
        ...
        series: [
          {
            ...
            areaStyle: {
              ...
              color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                ...
                {
                  offset: 0.8,
                  color: 'rgba(0, 178, 255, 0)'
                }
              ])
            },
            // data: [140, 232, 101, 264, 90, 340, 250]
            data: temp.defensetotal
          },
          {
            name: '防御成功次数',
            type: 'line',
        ...
        series: [
          {
            ...
            // data: [140, 232, 101, 264, 90, 340, 250]
            data: temp.probability
          },]
      }



      this.Gechart = echarts.init(this.$refs.alarmt_echart_top);
      this.Gechart2 = echarts.init(this.$refs.alarmt_echart_bot);
      this.Gechart.setOption(option);
      this.Gechart2.setOption(option2);
      const task = () => {
        this.Gechart.resize();
