...
export const asyncLoad = (loader, namedExport = 'default') =>
  Loadable({
    loader,
    loading: Empty,
    render(loaded, props) {
      let Component = loaded[namedExport] || loaded;
      const { forwardedRef, ...rest } = props;
      return <Component ref={forwardedRef} {...rest} />;
    },
  });

export const asyncLoadWithSelectable = (loader, namedExport = 'default') =>
  Loadable({
    loader,
    loading: Loading,
    render(loaded, props) {
      let Component = createSelectable(loaded[namedExport]);
      const { forwardedRef, ...rest } = props;
      return <Component ref={forwardedRef} {...rest} />;
    },
  });
