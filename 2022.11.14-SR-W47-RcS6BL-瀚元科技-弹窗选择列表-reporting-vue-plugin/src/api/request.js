...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY2ODgyMzE3Mzc1NCwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.sV9V7lbVeaudycn8fplvKeM2lq4RxAec_cN0YSR4Jvs";
   apiContextPath = "/api";
}
