...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3MTc4MjgyNjk5NSwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.BpYAJcoHbmjZXxW7wmR9EJciEK7prIx8ZuDtauoMna0";
   apiContextPath = "/api";
}
