<template>
   <div :style="{ width: '100%', height: '100%' }" ref="hy_set" class="outermost">
      ...
      >
         <!-- 表格 -->
         <el-table :data="tableDialogData" :row-class-name="tableRowClassName" height="405px" row-key="data_id" @selection-change="selectTabel">
...
export default {
   ...
   created() {
      if (process.env.NODE_ENV !== "development") {
         let columnStyle = JSON.parse(this.customConfig.component.columnStyle.customPluginConfig);
         // 资产ID
