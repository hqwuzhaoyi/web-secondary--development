...
export const customConfig = {
  ...
  // dirAssetId: '293d793e-1a36-4fce-bfe6-fb165aba5b39',//目录资产id
  // dirAssetId: '29e44812-a5e8-4f6d-59a8-32b9dfce694d',//目录资产id
  dirAssetId: '69476e49-919f-195b-61b3-6855d25b72fc',//目录资产id
  directoryLable: 'FOLDER_NAME',//目录名称字段
  // enclosureAssetId: '5a6c9715-0f0f-1559-6d94-eb82e88aff94',//附件资产id
  enclosureAssetId: 'df948274-87d8-d51b-4c80-95d67deb6912',//附件资产id
  enclosureName: 'NAME',//附件名称字段
  enclosureDate: 'UPLOAD_DATE',//附件时间字段
  enclosureId: 'ID',//获取附件时需要配置的字段
  voucherIdFiled: 'voucher_id' //取url中指定的字段
};
