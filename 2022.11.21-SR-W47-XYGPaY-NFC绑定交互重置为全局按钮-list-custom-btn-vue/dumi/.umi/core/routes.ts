...
import { ApplyPluginsType } from 'D:/workTest/南山IOT/iotNFC-React/node_modules/_@umijs_runtime@3.5.35@@umijs/runtime';
...
export function getRoutes() {
  const routes = [
  {
    ...
    "component": ((props) => {
        ...
        const { default: getDemoRenderArgs } = require('D:/workTest/南山IOT/iotNFC-React/node_modules/_@umijs_preset-dumi@1.1.49@@umijs/preset-dumi/lib/plugins/features/demo/getDemoRenderArgs');
  ...
  },
  {
    ...
    "layout": false,
    "path": "/",
    "wrappers": [require('../dumi/layout').default, require('D:/workTest/南山IOT/iotNFC-React/node_modules/_dumi-theme-default@1.1.24@dumi-theme-default/es/layout.js').default],
    "routes": [
      {
        "path": "/reporting/快速开始/1",
        "component": require('D:/workTest/南山IOT/iotNFC-React/dumi/docs/1.快速开始.md').default,
        "exact": true,
        "meta": {
          "filePath": "dumi/docs/1.快速开始.md",
          "updatedTime": 1668478372279,
          "title": "快速开始",
          "nav": {
            "title": "填报",
            "path": "/reporting"
      ...
      },
      {
        ...
        "component": require('D:/workTest/南山IOT/iotNFC-React/dumi/docs/2.开发插件.md').default,
        "exact": true,
        "meta": {
      ...
      },
      {
        ...
        "component": require('D:/workTest/南山IOT/iotNFC-React/dumi/docs/3.使用插件.md').default,
        "exact": true,
        "meta": {
      ...
      },
      {
        ...
        "component": require('D:/workTest/南山IOT/iotNFC-React/dumi/docs/4.API.md').default,
        "exact": true,
        "meta": {
          "filePath": "dumi/docs/4.API.md",
          "updatedTime": 1668478372280,
          "title": "API",
          "nav": {
            "title": "填报",
            "path": "/reporting"
      ...
      {
        "path": "/",
        "component": require('D:/workTest/南山IOT/iotNFC-React/dumi/docs/index.md').default,
        "exact": true,
        "meta": {
          "filePath": "dumi/docs/index.md",
          "updatedTime": 1668478372284,
          "hero": {
            "title": "sdata-plugins",
      ...
      },
      {
        ...
        "component": require('D:/workTest/南山IOT/iotNFC-React/dumi/docs/快速预览.md').default,
        "exact": true,
        "meta": {
