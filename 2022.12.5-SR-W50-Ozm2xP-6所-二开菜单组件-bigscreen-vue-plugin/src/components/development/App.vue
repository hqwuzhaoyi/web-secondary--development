  ...
  <div id="development">
    <el-carousel arrow="always" :autoplay="false">
      <el-carousel-item v-for="item in renderMap" :key="item">
        <component :is="item" v-bind="mockData" />
      </el-carousel-item>
    </el-carousel>
  </div>
</template>
...
import Vue from "vue";
import { Main, DataConfiguration, StyleConfiguration, OtherConfiguration } from "@/components";
...
export default {
  ...
  data() {
    return {
      renderMap: ["Main", "DataConfiguration", "StyleConfiguration", "OtherConfiguration"],
      mockData,
    };
  },
  created() {},
