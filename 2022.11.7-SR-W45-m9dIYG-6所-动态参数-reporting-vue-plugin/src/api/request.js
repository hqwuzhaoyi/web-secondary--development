...
if (process.env.NODE_ENV === "development") {
  document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY2ODIxNzk1NjY3MCwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.8Tf8ZhHhwgCYf4-JZ0_GxAkmhC2NsfIwCIVJQifvgBQ";
  apiContextPath = "/api";
}
