...
if (process.env.NODE_ENV === "development") {
  document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY2Mzc0Mzk5NjAxMywidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.rpLomVHy1zLyxCie-Sh7hsuslfEbbmHQahBZwKCk4cE";
  apiContextPath = "/api";
}
