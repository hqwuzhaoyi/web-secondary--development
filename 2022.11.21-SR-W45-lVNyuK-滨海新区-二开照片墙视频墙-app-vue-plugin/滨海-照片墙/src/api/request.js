...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY2OTE2OTQ1MzExNCwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.E9YJ01bbXWi3bfCconyMStAyEahRVCdBRfuXD-ux5EM";
   apiContextPath = "/api";
}
