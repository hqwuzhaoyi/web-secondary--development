...
if (process.env.NODE_ENV === "development") {
  document.cookie =
    "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY2OTk3MDY2OTU4MywidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.3wLeSLTlsbHy5Xwzpg8L5mJrc4cKHxnKaX9VXDYkvbI";
  document.cookie =
...
const instance = axios.create({
  baseURL: `${apiContextPath}/gxpt/sdata/rest`,
  timeout: 60000,
