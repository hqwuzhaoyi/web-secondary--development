<template>
  <div :id="id" ref="app-secondary" class="app-secondary">
    ...
    <div class="tableRight">
      <div class="topSearch">
        <el-input style="width: 120px; margin-right: 10px" size="small" v-model="name" placeholder="姓名"></el-input>
        <el-input style="width: 120px; margin-right: 10px" size="small" v-model="department" placeholder="单位名称"></el-input>
        <el-input style="width: 120px; margin-right: 10px" size="small" v-model="phone" placeholder="手机"></el-input>
        <el-input style="width: 120px; margin-right: 10px" size="small" v-model="call" placeholder="办公电话"></el-input>
        <el-button size="small" type="primary" @click="searchTable">搜索</el-button>
        <el-button size="small" @click="clearSearh">重置</el-button>
      </div>
