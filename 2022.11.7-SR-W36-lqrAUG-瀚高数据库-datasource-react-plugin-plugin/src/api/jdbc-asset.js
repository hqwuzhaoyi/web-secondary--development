...
export const analyzeAssetSchema = params => request.post(`asset/analyzeAssetSchema`, params);
 ...
 * intl.get('COMM.QDMI')
 */
export const assetQueryModel = id => request.get(`asset/queryModel?assetId=${id}`);
 ...
 * intl.get('COMM.QDRI')
 */
export const associations = id => request.get(`asset/associations?assetId=${id}`);
/**
 ...
 * intl.get('COMM.UDR')
 */
export const updateAssociations = params => request.post(`asset/updateAssociations`, params);

/**
 * intl.get('COMM.QDPI')
 */
export const queryAuthByAssetId = id => request.get(`asset/auth/queryByAssetId?asset_id=${id}`);

/**
 * intl.get('COMM.UDP')
 */
export const updateAssetASuth = params => request.post(`asset/auth/update`, params);
 ...
 */
export const queryAssetData = (id, params, count, pageNum, pageSize) =>
	request.post(
		`asset/getAssetData?asset_id=${id}${
			count || count === 0 ? '&count=' + count : '&count=' + ''
		}&pageNum=${pageNum || pageNum === 0 ? pageNum : ''}&pageSize=${
...
export const queryAssetData2 = (id, params, count, token, options) =>
	request.post(
		`asset/getAssetData?asset_id=${id}${count || count === 0 ? '&count=' + count : ''}`,
		params,
		options
	);
 ...
 * intl.get('COMM.QDIASLS')token
 */
export const getAssetDataForBigScreen2 = (id, params, count, token, options) =>
	request.post(
		`bigscreen/meta/getAssetDataForBigScreen?asset_id=${id}${
			count || count === 0 ? '&count=' + count : ''
		}&token=${token}`,
 ...
 * intl.get('EVEN.QUERY_DATA')
 */
export const queryFormAssetData = (id, form_id, params, distinct_column) =>
	request.post(
 ...
 */
export const onlyQueryAssetDataDistinct = (id, form_id, params, form_column_id) => {
	if (form_column_id) {
		return request.post(
...
export const getAssetDataByFilterUseCache = (id, form_id, params) => {
	return request.post(`form/assetData/getAssetData?asset_id=${id}&form_id=${form_id}`, params, {
		useCache: true,
		cacheDuration: 500,
	});
};
 ...
 * intl.get('COMM.QOAWBF')
 */
export const onlyQueryAssetDataDistinctUseCache = (id, form_id, params, form_column_id) => {
	if (form_column_id) {
		return request.post(
			`form/queryAssetDataDistinct?asset_id=${id}&form_id=${form_id}&form_column_id=${form_column_id}`,
			params
 ...
 * intl.get('COMM.QFAF')
 */
export const autoComplete = id => request.get(`asset/autoComplete?asset_id=${id}`);
 ...
 * intl.get('COMM.UDDF')
 */
export const updateQueryCols = params => request.post(`asset/updateQueryCols`, params);

/**
 * intl.get('COMM.UDQF')
 */
export const updateDisplayCols = params => request.post(`asset/updateDisplayCols`, params);

/**
 * intl.get('COMM.EXPORT_ASSETS')
 */
export const exportAssetData = (id, key, params) =>
	request.post(`asset/assetData/export?asset_id=${id}&fileType=${key}`, params, {
		responseType: 'blob',
	});
 ...
 */
export const queryXml = sourceId => request.get(`dataSource/xml/queryXml?sourceId=${sourceId}`);

/**
 * intl.get('COMM.QKM')
 */
export const queryGraph = assetId => request.get(`/asset/graph/queryGraph?assetId=${assetId}`);
 ...
 */
export const updateModel = params => request.post(`/asset/updateModel`, params);
...
//   );
export const queryJoinSearch = params => request.get('asset/queryJoinSearch', { params });
...
export const thinkKeySearch = (id, keyWord, type) =>
	request.get(
		`asset/thinkKeySearch?assetId=${id}&keyWord=${keyWord}${type ? '&type=' + type : ''}`
	);
...
// intl.get('COMM.AOUAL')
export const addOrUpdateLifecycle = params => request.post(`asset/lifecycle/addOrUpdate`, params);

// 按照id删除生命周期
export const deleteLifecycleById = id => request.get(`asset/lifecycle/deleteById?id=${id}`);
