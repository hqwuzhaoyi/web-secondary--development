...
export const customConfig = {
  ...
  // catalogueId: 'b495f122-2bd7-0a7a-3678-81b9740086b7'
  catalogueAssetId: 'bc674653-bb2a-c8eb-4fdd-dad64d4b860c',//目录资产id
  catalogueName: 'name',//目录 名称字段
  catalogueParentId: 'parent_id',//目录 父节点字段
  catalogueId: 'id',// 目录 id字段
  cameraAssetId: '49757169-0600-12a4-45d5-25645a90d816',// 摄像头资产id
  cameraId: 'data_id',//摄像 id字段
  cameraChannelId: 'channelId',//摄像 channelid字段
  cameraName: 'channelName',//摄像 名称字段
  parent_id: '001'
};
