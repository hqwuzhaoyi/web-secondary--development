<template>
  <div class="secondary_bigscreen zdfyjgtj" :style="{
    ...
    <div>
      ...
      <el-select popper-class="inputSelectBacPoper" v-model="provinceSelect" :disabled="Boolean(province)"
        placeholder="请选择" class="inputSelectBac" @change="changeProvince" value-key="province_id" style="width: 120px"
        size="small">
      ...
      <el-select size="small" v-model="stationSelect" popper-class="inputSelectBacPoper"
        :disabled="Boolean(substationName)" placeholder="请选择" class="inputSelectBac" @change="changeStation"
    ...
    <el-table :data="tableData" stripe
      ...
      <el-table-column prop="substation_level" label="重点目标等级" width="170"> </el-table-column>
      ...
      <el-table-column prop="defect_level" label="缺陷类型" max-width="150"> </el-table-column>
      <el-table-column prop="findFlawNum" label="缺陷次数" max-width="150"> </el-table-column>
      <el-table-column prop="firstTime" label="首次发现日期" width="200"> </el-table-column>
      <el-table-column prop="lastTime" label="最后发现日期" min-width="200"> </el-table-column>
    </el-table>
...
import { queryDropDownBox, deviceFlawStatistics } from "../../api/asset";
...
export default {
  ...
  mounted() {
    ...
    this.pubSub &&
      this.pubSub.subscribe("updateChart" + this.componentId, (data) => {
        this.province = data.variable.current_value && JSON.parse(data.variable.current_value).province_id || ''
        this.city = data.variable.current_value && JSON.parse(data.variable.current_value).city_id || ''
        this.substationName = data.variable.current_value && JSON.parse(data.variable.current_value).substation_no || ''
  ...
  methods: {
    ...
    searchTable() {
      ...
      deviceFlawStatistics(message).then((res) => {
