...
if (process.env.NODE_ENV !== "production") {
  ...
  const customConfig = {
    componentId: "111",
    data: '[{"assetid":"a400edb5-ddc3-46a7-b684-0b9886982376","assetname":"房产金额","column":"金额"},{"opeartion":"*"},{"assetid":"a400edb5-ddc3-46a7-b684-0b9886982376","assetname":"房产金额","column":"房产名称"}]',
    saveValue: [],
    onChange: (values: any) => {
      console.log(values);
    },
  ...
  window.CUSTOM_PLUGIN.set(
    ...
    (dom: any, props: any, context: any) => {
      ...
      props.setSetPluginProps && props.setSetPluginProps((props: any) => {
