      ...
      <div class="alarmt_two_right">
        ...
        <div class="alarmt_two_main">
          ...
          <div class="alarmt_two_main_table">
            <div class="alarmt_two_main_table_title  border_title">巡检结果
            ...
            <div ref="alarmt_main_three" class="alarmt_two_main_table_main">
              <div class="table_item" v-for=" o in  3 " :key="o">
                <el-table :data="tableData[o - 1]" style="width: 100%" stripe>
                  ...
                  <el-table-column prop="total" label="任务总次数" align="center">
                  </el-table-column>
                  <el-table-column prop="Execute" label="任务执行次数" align="center">
                  </el-table-column>
                  <el-table-column prop="noExecute" label="未执行次数" align="center">
                  </el-table-column>
                  <el-table-column prop="probability" label="任务执行率" align="center">
                  </el-table-column>
                </el-table>
              </div>
...
export default {
  ...
  methods: {
    ...
    //渲染图表
    initEchartFn(data) {
      let temp = { defensetotal: [], Execute: [], noExecute: [], probability: [] }
      let xAxData = []

      data.forEach((x, i) => {
        temp.Execute.push(x.Execute)
        temp.noExecute.push(x.noExecute)
