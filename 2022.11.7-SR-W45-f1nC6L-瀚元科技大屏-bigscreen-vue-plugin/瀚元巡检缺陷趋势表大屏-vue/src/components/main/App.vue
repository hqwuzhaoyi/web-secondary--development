...
import { pollingFlawTrend, queryDropDownBox } from "../../api/asset";
import Vue from "vue";
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      this.tableHeight = this.$refs.alarmt_main_tow.offsetHeight;
    })
