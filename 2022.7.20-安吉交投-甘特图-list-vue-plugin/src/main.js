...
import { Input, Form, FormItem, Select, Option, Loading, Button } from "element-ui";
import "./index.css";
...
if (process.env.NODE_ENV !== "production") {
  ...
  const customConfig = {
    ...
    configuration: {
      timeStep: "time",
      detailsID: "55c536ec-2869-46e5-96b6-332c547d6329",
      insertID: "3c3c24d9-1864-49da-9fde-2f4ab831005c",
      deleteKey: "",
      taskMappingField: "room_choice",
      taskID: "e1a02ed7-ae11-541f-7f5e-fe7617d81f79",
      taskField: "项目名称: {{room_choice}}",
    },
  };
