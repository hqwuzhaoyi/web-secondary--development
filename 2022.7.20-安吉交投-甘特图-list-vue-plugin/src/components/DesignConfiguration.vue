<template>
  <el-form ref="form" :model="form" label-width="80">
    ...
    <!-- 配置表单ID -->
    <el-form-item label="详情页ID">
      <el-input v-model="form.detailsID" placeholder="请输入详情页ID" size="small"></el-input>
    </el-form-item>
    <el-form-item label="编辑页ID">
      <el-input v-model="form.insertID" placeholder="请输入编辑页ID" size="small"></el-input>
    </el-form-item>
    <!-- 项目资产ID -->
...
export default {
  ...
  watch: {
    ...
    "form.detailsID": function (value, oldValue) {
      this.onFormLayoutChange();
    },
    "form.insertID": function (value, oldValue) {
      this.onFormLayoutChange();
    },
