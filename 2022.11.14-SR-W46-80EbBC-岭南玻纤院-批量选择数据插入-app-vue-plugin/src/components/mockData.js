...
export const customConfig = {
  componentId: "123",
  appId: "123",
  // 列表A资产ID: "edd869a0-6384-055f-a0be-f0885d50b4d8",
  // 列表A显示字段: "所属实验室,项目编号,检验项目,检验对象,方法,是否有分析项（0:否，1:是）,检测人员",
  列表资产ID: "fcb1d25f-f657-3fe6-ff6a-50446ad4ea89",
  列表显示字段: "主键,检验项目,创建时间",
  时间显示格式: "YYYY/MM/DD",
  系统变量名称: "Knowloedge_Id",
